                        ...
                        <table style="width:100%; border-collapse:collapse; margin:16px 0;">
                            <tr style="background:#f9f9f9;">
                                <td style="padding:12px; border:1px solid #eee;
                                           font-weight:bold; width:35%;">Job Name</td>
                                <td style="padding:12px; border:1px solid #eee;">
                                    ${env.JOB_NAME}
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:12px; border:1px solid #eee;
                                           font-weight:bold;">Build Number</td>
                                <td style="padding:12px; border:1px solid #eee;">
                                    #${env.BUILD_NUMBER}
                                </td>
                            </tr>
                            ...
                            <tr style="background:#f9f9f9;">
                                <td style="padding:12px; border:1px solid #eee;
                                           font-weight:bold;">Build URL</td>
                                <td style="padding:12px; border:1px solid #eee;">
                                    <a href="${env.BUILD_URL}" style="color:#1976d2;">
                                        Click here to view
                                    </a>
                                </td>
                            </tr>
...
## For Outlook emails not receiving

Go to **Jenkins → Manage Jenkins → System** scroll to **Extended E-mail Notification** and check:

**Default Recipients** field — make sure all 4 emails are there:
```
sprdmntester@gmail.com, devender.ripple@gmail.com, chakravarthi@ripplemetering.com, preethi@ripplemetering.com
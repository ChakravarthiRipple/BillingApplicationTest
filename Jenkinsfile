    ...
    post {
        ...
        success {
            ...
            emailext (
                ...
                <div style="max-width:600px; margin:auto; background:white;
                    ...
                    <div style="padding:24px;">
                        ...
                        <p style="color:#333;">All tests have <b style="color:#00c853;">PASSED</b>.</p>
                        <table style="width:100%; border-collapse:collapse; margin:16px 0;">
                            ...
                            <tr style="background:#f9f9f9;">
                                ...
                                <td style="padding:12px; border:1px solid #eee;">
                                    <span style="background:#00c853; color:white; padding:4px 12px; border-radius:20px;">PASSED</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding:12px; border:1px solid #eee; font-weight:bold;">Allure Report</td>
                                <td style="padding:12px; border:1px solid #eee;">
                                    <a href="${env.BUILD_URL}allure/" style="color:#1976d2;">View Report</a>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div style="background:#f9f9f9; padding:16px; text-align:center; border-top:1px solid #eee;">
                        <p style="color:#888; font-size:12px; margin:0;">Jenkins CI/CD | Ripple Metering Automation | Regards, Chakravarthi G</p>
                    </div>
                </div>
                </body></html>
                """
            ...
            emailext (
                subject: "BUILD PASSED - ${env.JOB_NAME} #${env.BUILD_NUMBER}",
                mimeType: 'text/html',
                to: "chakravarthi@ripplemetering.com,preethi@ripplemetering.com",
                body: """
                <html>
                <body style="font-family:Arial,sans-serif; background:#f4f4f4; padding:20px;">
                <div style="max-width:600px; margin:auto; background:white;
        ...
        failure {
            ...
            emailext (
                ...
                <div style="max-width:600px; margin:auto; background:white;
                    ...
                    <div style="padding:24px;">
                        <p style="color:#333;">Hi Team,</p>
                        <p style="color:#333;">The build has <b style="color:#e53935;">FAILED</b>. Please check the attached log.</p>
                        <table style="width:100%; border-collapse:collapse; margin:16px 0;">
                            <tr style="background:#f9f9f9;">
                                <td style="padding:12px; border:1px solid #eee; font-weight:bold; width:35%;">Job</td>
                                <td style="padding:12px; border:1px solid #eee;">${env.JOB_NAME}</td>
                            ...
                            <tr style="background:#f9f9f9;">
                                <td style="padding:12px; border:1px solid #eee; font-weight:bold;">Status</td>
                                <td style="padding:12px; border:1px solid #eee;">
                                    <span style="background:#e53935; color:white; padding:4px 12px; border-radius:20px;">FAILED</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:12px; border:1px solid #eee; font-weight:bold;">Duration</td>

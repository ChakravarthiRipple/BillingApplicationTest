                    ...
                    <div style="padding:24px;">
                        <table style="width:100%; border-collapse:collapse;">
                            <tr style="background:#f9f9f9;">
                                <td style="padding:12px; border:1px solid #eee; font-weight:bold;">Job</td>
                            ...
                            <tr style="background:#f9f9f9;">
                                ...
                                <td style="padding:12px; border:1px solid #eee;">
                                    <span style="background:#00c853; color:white; padding:4px 12px;
                                                 border-radius:20px; font-weight:bold;">PASSED ✅</span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr style="background:#f9f9f9;">
                                <td style="padding:12px; border:1px solid #eee; font-weight:bold;">URL</td>
                                <td style="padding:12px; border:1px solid #eee;">
                    ...
                    <div style="padding:24px;">
                        <table style="width:100%; border-collapse:collapse;">
                            ...
                            <tr style="background:#f9f9f9;">
                                <td style="padding:12px; border:1px solid #eee; font-weight:bold;">Status</td>
                                <td style="padding:12px; border:1px solid #eee;">
                                    <span style="background:#e53935; color:white; padding:4px 12px;
                                                 border-radius:20px; font-weight:bold;">FAILED ❌</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:12px; border:1px solid #eee; font-weight:bold;">Duration</td>
                        ...
                        <div style="background:#fff3e0; border-left:4px solid #ff9800;
                            ...
                            <p style="margin:0; color:#e65100; font-size:13px;">
                                ⚠️ Build log is attached. Please fix the failing tests.
                            </p>
                        </div>
                        <div style="text-align:center; margin-top:20px;">
                            <a href="${env.BUILD_URL}"
